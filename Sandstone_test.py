...
if st.button('Calculate'):
    ...
    def rhs(s, v): 
          if AnkeriteRockVolume==0. or v[13]<=0.:
              multankerite = 0.
          else:
              multankerite = 1
              
          if DolomiteRockVolume==0. or v[11]<=0.:
              multdolomite = 0.
          else:
              multdolomite = 1
    
          if ZeoliteRockVolume==0. or v[14]<=0.:
              multzeolite = 0.
          else:
              multzeolite = 1 
          ...
          if SideriteRockVolume==0. or v[12]<=0.:
             multisiderite = 0.
          else:
             multisiderite = 1
             
          if ChloriteRockVolume==0. or v[12]<=0.:
              multchlorite = 0.
          else:
              multchlorite = 1
              
          if MontmorilloniteRockVolume==0. or v[19]<=0.:
             multmontmorillonite = 0.
          else:
             multmontmorillonite = 1
             
          if NafelsparRockVolume==0. or v[15]<=0.:
              multnafelspar = 0.
          else:
              multnafelspar = 1

          if KaoliniteRockVolume==0. or v[16]<=0.:
              multkaolinite = 0.
          else:
              multkaolinite = 1
          ...
          rcaf2 = kcalcite_hf*multcalcite*v[1]+kankerite_hf*multankerite*v[1]*Densityankerite/Molwtankerite+kdolomite_hf*multdolomite*v[1]*Densitydolomite/Molwtdolomite
         
          rdolomite = (-kdolomite_hf*multdolomite*v[1]-kdolomite_hcl*multdolomite*np.power(v[0],1))*Densitydolomite/Molwtdolomite
          rsiderite = -ksiderite_hcl*multisiderite*np.power(v[0],1)*Densitysiderite/Molwtsiderite*multcalcite
          rankerite = (-kankerite_hf*multankerite*v[1]-kankerite_hcl*multankerite*np.power(v[0],1))*Densityankerite/Molwtankerite
    ...
    print("res1=",np.power(res.y[1],1.))
    print("res2=",np.power(res.y[2],1.))
    print("res3=",np.power(res.y[3],1.))
    print("res4=",np.power(res.y[4],1.))
    print("res5=",np.power(res.y[5],1.))
    print("res6=",np.power(res.y[6],1.))
    print("res7=",np.power(res.y[7],1.))
    print("res8=",np.power(res.y[8],1.))
    print("res9=",np.power(res.y[9],1.))
    print("res10=",np.power(res.y[10],1.))
    print("res11=",np.power(res.y[11],1.))
    print("res12=",np.power(res.y[12],1.))
